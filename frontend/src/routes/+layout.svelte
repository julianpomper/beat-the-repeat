    ...
    <main>
        <div class="w-full h-screen">
            <div class="bg-gray-900 h-full flex justify-center items-center relative">
                ...
                <div class="relative flex justify-center isolate overflow-hidden bg-gray-900 shadow-2xl md:rounded-3xl md:h-auto h-full w-full md:w-auto md:px-32 py-24 px-8">
