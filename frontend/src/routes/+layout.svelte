    ...
    <main>
        <div class="w-full h-screen">
            <div class="bg-gray-900 md:py-16 overflow-y-auto h-full flex flex-col items-center relative">
                ...
                <div
                  class="relative md:overflow-hidden overflow-y-auto overflow-x-hidden flex-shrink-0 isolate bg-gray-900 shadow-2xl md:rounded-3xl md:h-auto h-full w-full md:w-auto md:px-32 py-24 px-8">
